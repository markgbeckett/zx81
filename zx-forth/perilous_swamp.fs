...
( ON EXIT, FLAG = 1 IF ESCAPED, = 2 IF FIGHT, = 0 IF EATEN )
: CHECKRUN ( BEAST -- FLAG )
    12 RND ( BEAST II )
...
: DOZAP ( MONSTER TREASURE MSTRENGTH -- MONSTER TREASURE MSTRENGTH FLAG )
...
: HANDLELOC ( X Y -- X Y FLAG )
    ...
    1 HFLAG ! ( INITIALLY, PLAYER HAS CHOICES )

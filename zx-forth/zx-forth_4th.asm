;; Sketching out how I might port ZX-Forth to the Minstrel 4th/ Jupiter
;; Ace. At a high level looks okay.
;; The Ace restart routine does:
;; - DI
;; - Work out RAM top
;; - Set SP
;; - Set up system variables
;; - Set up IX and IY
;; - Clear screen (including 00 at end of screen)
;; - Set up character RAM
;; - EI

;; Some of these steps are not needed for ZX-Forth, or replaced by
;; different routines.
...
RUN_VSYNC:
BB_OFF:	;; nop
;; 	;; out (0xFD),a		;0098 - Disable NMI Generator
;; VS_ON:	nop
;; 	;; nop
;; 	;; in a,(0xFE)		;009a - Turn on VSync
...
VS_OFF:	nop
	nop
	;; out (0ffh),a	; (11) 0100 - Disable VSync REPLACE - was at 0x100
TB_ON:	nop
	nop
	
	;; out (0feh),a	; (11) 0102 - Enable NMI Generator
...
l0991h: nop
	nop
	nop
	;; 	call CHECK_FP_ROM	;0991 - check if ROM/ RAM in 2000--3FFF
...
KEY_CODES: 	;; Keyboard mapping (unshifted)
...
DEFVARS:
	...
	db 0x1F, 0x0F, 0x00, 0x20	; IX+7 was 0x00
	db 0x00, 0x00, 0x00, 0x00	; SCREEN_INFO_CO (1DF6)
	db 0x1F, 0x17, 0x00, 0x20       ; IX+7 was 0x00
	db 0x00				; FLAGS2
	db 0x0F				; TOKEN_LN
